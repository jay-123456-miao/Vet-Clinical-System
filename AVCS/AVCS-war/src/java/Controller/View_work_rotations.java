 ...
 * @author ASUS
 */
@WebServlet(name = "View_work_rotations", urlPatterns = {"/View_work_rotations"})
public class View_work_rotations extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
            if (rotationList != null) {
                    ...
                    for (WorkingRotation rotation: rotationList) {
                        ...
                        out.println("<tr><td></td> <td></td> <td></td> <td></td> <td></td> <td align =\"right\"><form action= \"Delete_working_rotations\" method=\"post\"><input type=\"submit\" value=\"Delete\" name= \""+String.valueOf(rotation.getId())+"\"></form></td><td align =\"right\"><form action= \"Edit_rota\" method=\"post\"><input type=\"submit\" value=\"Edit\" name= \""+String.valueOf(rotation.getId())+"\"></form></td><tr>");
                        out.println("</table>");
                    }
                } else {
