 ...
 * @author ASUS
 */
@WebServlet(name = "Save_edited_work_rotations", urlPatterns = {"/Save_edited_work_rotations"})
public class Save_edited_work_rotations extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        long rotationsIDToBeEdited = (long)s.getAttribute("rotationIDTobeEdited");
        WorkingRotation rotationToBeEdited = workingRotationFacade.find(rotationsIDToBeEdited);
...
//            
            ...
            if (!duplicated && !expertise_num_not_reach) {
                ...
                rotationToBeEdited.setMonVet1(rota[0][0]); 
                rotationToBeEdited.setMonVet2(rota[1][0]);
                rotationToBeEdited.setMonVet3(rota[2][0]);
                rotationToBeEdited.setTueVet1(rota[0][1]);        
                rotationToBeEdited.setTueVet2(rota[1][1]);
                rotationToBeEdited.setTueVet3(rota[2][1]);
                rotationToBeEdited.setWedVet1(rota[0][2]);        
                rotationToBeEdited.setWedVet2(rota[1][2]);
                rotationToBeEdited.setWedVet3(rota[2][2]);
                rotationToBeEdited.setThursVet1(rota[0][3]);        
                rotationToBeEdited.setThursVet2(rota[1][3]);
                rotationToBeEdited.setThursVet3(rota[2][3]);
                rotationToBeEdited.setFriVet1(rota[0][4]);        
                rotationToBeEdited.setFriVet2(rota[1][4]);
                rotationToBeEdited.setFriVet3(rota[2][4]);
                rotationToBeEdited.setSatVet1(rota[0][5]);
                rotationToBeEdited.setSatVet2(rota[1][5]);
                rotationToBeEdited.setSatVet3(rota[2][5]);
                rotationToBeEdited.setSunVet1(rota[0][6]);
                rotationToBeEdited.setSunVet2(rota[1][6]);
                rotationToBeEdited.setSunVet3(rota[2][6]);                
                workingRotationFacade.edit(rotationToBeEdited);
