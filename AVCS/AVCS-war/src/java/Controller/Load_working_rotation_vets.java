 ...
 * @author ASUS
 */
@WebServlet(name = "Load_working_rotation_vets", urlPatterns = {"/Load_working_rotation_vets"})
public class Load_working_rotation_vets extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("Vet/view_working_rotations.jsp").include(request, response);
